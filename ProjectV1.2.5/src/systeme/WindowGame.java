...
public class WindowGame {
	...
	public WindowGame(int nbjoueur,String prenom,String nom,List<String> prenomJ,List<String> nomJ,List<String> potionBani) {
		...
		for(int j=0;j<this.pioche.size();j++) {
			this.pioche.get(j).melangerPotion();
		}
	}
	...
	public void setTasJetonCompetence(TasJeton tasJetonCompetence) {
		this.tasJetonCompetence = tasJetonCompetence;
	}

	public void setPioche(List<TasPotion> pioche) {
		this.pioche = pioche;
	}
